...
class ListActivityRemoveContacts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets list_ids
     *
     * @param string[] $list_ids Specifies which lists (up to 50) to remove your source contacts from.
     *
     * @return self
     */
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling ListActivityRemoveContacts., number of items must be less than or equal to 50.');
        }
