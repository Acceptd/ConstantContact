 ...
 */
class EmailCampaignActivityDocumentProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailCampaignActivity_document_properties';
    ...
    */
    ...
    public function setStyleContent($style_content)
    {
        ...
        if ((mb_strlen($style_content) > 150000)) {
            throw new \InvalidArgumentException('invalid length for $style_content when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 150000.');
        }
    ...
    public function setGreetingSalutation($greeting_salutation)
    {
        ...
        if ((mb_strlen($greeting_salutation) > 50)) {
            throw new \InvalidArgumentException('invalid length for $greeting_salutation when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 50.');
        }
    ...
    public function setGreetingSecondary($greeting_secondary)
    {
        ...
        if ((mb_strlen($greeting_secondary) > 1500)) {
            throw new \InvalidArgumentException('invalid length for $greeting_secondary when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 1500.');
        }
    ...
    public function setSubscribeLinkName($subscribe_link_name)
    {
        ...
        if ((mb_strlen($subscribe_link_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $subscribe_link_name when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 80.');
        }
    ...
    public function setTextContent($text_content)
    {
        ...
        if ((mb_strlen($text_content) > 150000)) {
            throw new \InvalidArgumentException('invalid length for $text_content when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 150000.');
        }
    ...
    public function setPermissionReminder($permission_reminder)
    {
        ...
        if ((mb_strlen($permission_reminder) > 1500)) {
            throw new \InvalidArgumentException('invalid length for $permission_reminder when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 1500.');
        }
    ...
    public function setViewAsWebpageText($view_as_webpage_text)
    {
        ...
        if ((mb_strlen($view_as_webpage_text) > 50)) {
            throw new \InvalidArgumentException('invalid length for $view_as_webpage_text when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 50.');
        }
    ...
    public function setForwardEmailLinkName($forward_email_link_name)
    {
        ...
        if ((mb_strlen($forward_email_link_name) > 80)) {
            throw new \InvalidArgumentException('invalid length for $forward_email_link_name when calling EmailCampaignActivityDocumentProperties., must be smaller than or equal to 80.');
        }
