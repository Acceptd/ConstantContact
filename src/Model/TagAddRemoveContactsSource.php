 ...
 */
class TagAddRemoveContactsSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagAddRemoveContacts_source';
    ...
    */
    ...
    public function setContactIds($contact_ids)
    {
        ...
        if ((count($contact_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling TagAddRemoveContactsSource., number of items must be less than or equal to 500.');
        }
    ...
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling TagAddRemoveContactsSource., number of items must be less than or equal to 50.');
        }
    ...
    public function setTagIds($tag_ids)
    {
        ...
        if ((count($tag_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $tag_ids when calling TagAddRemoveContactsSource., number of items must be less than or equal to 50.');
        }
     ...
     *
     * @param bool|null $all_active_contacts Use to identify contacts with an active status.
     *
     * @return self
     */
