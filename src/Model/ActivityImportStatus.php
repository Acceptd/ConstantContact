...
/**
 * ActivityImportStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ActivityImportStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActivityImport_status';
    ...
    */
     ...
     *
     * @param int|null $items_total_count The total number of rows in the import file.
     *
     * @return self
     */
