...
/**
 * EmailSendHistoryInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EmailSendHistoryInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailSendHistory_inner';
    ...
    */
    ...
    public function setSendId($send_id)
    {
        ...
        if (($send_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $send_id when calling EmailSendHistoryInner., must be bigger than or equal to 1.');
        }
