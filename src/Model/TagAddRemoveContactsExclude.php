 ...
 */
class TagAddRemoveContactsExclude implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TagAddRemoveContacts_exclude';
