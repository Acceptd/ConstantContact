...
/**
 * ListActivityRemoveContactsSource Class Doc Comment
 *
 * @category Class
 ...
 */
class ListActivityRemoveContactsSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListActivityRemoveContacts_source';
    ...
    */
     ...
     * Sets list_ids
     *
     * @param string[]|null $list_ids Specifies which contacts to remove from your target lists as an array of up to 50 contact <code>list_id</code> values. This property is mutually exclusive with <code>contact_ids</code> and <code>all_active_contacts</code>.
     *
     * @return self
     */
    public function setListIds($list_ids)
    {
        ...
        if ((count($list_ids) > 50)) {
            throw new \InvalidArgumentException('invalid value for $list_ids when calling ListActivityRemoveContactsSource., number of items must be less than or equal to 50.');
        }
     ...
     *
     * @param bool|null $all_active_contacts Removes all active contacts from your targeted lists. This property is mutually exclusive with <code>contact_ids</code> and <code>list_ids</code>.
     *
     * @return self
     */
     ...
     * Sets contact_ids
     *
     * @param string[]|null $contact_ids Specifies which contacts to remove from your target lists as an array of <code>contact_id</code> values. This property is mutually exclusive with <code>list_ids</code> and <code>all_active_contacts</code>.
     *
     * @return self
     */
    public function setContactIds($contact_ids)
    {
        ...
        if ((count($contact_ids) > 500)) {
            throw new \InvalidArgumentException('invalid value for $contact_ids when calling ListActivityRemoveContactsSource., number of items must be less than or equal to 500.');
        }
